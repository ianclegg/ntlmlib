...
class TargetInfoTestCase(unittest.TestCase):
    class Tokens(object):
            ...
            davenport_info = str(binascii.unhexlify('02000c0044004f004d00410049004e0001000c0053004500520056004500520004'
    ...
    def test_to_string_works_with_davenport_sample(self):
        ...
        self.assertEqual(self.tokens.davenport_info, str(target_info))
        pass
...
class ChallengeTestCase(unittest.TestCase):
    ...
    class Tokens(object):
        windows_nt4 = str(binascii.unhexlify('4e544c4d53535000020000001200120028000000050202005fc3e1acb7'
        ...
        windows_2003 = str(binascii.unhexlify('4e544c4d53535000020000001e001e003800000035828a6220b171806b5b081e'
